...
# initialise Dagster DB variables

export DAGSTER_POSTGRES_USER=MYSQL_DAGSTER_USERNAME
export DAGSTER_POSTGRES_PASSWORD=MYSQL_DAGSTER_PASSWORD
export DAGSTER_POSTGRES_DB=MYSQL_DAGSTER_DATABASE_NAME
